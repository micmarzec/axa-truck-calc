...
function generateXML(data) {
    const productCode = config_1.AppConfig.products[data.wariant]?.code || '01';
    ...
    const buildInsuranceNode = (parent, tarif, validFrom, validTo, numCust, price) => {
    ...
    if (isDoubleTariff) {
        ...
        if (hasT10Z)
            singleTariff = 'T10Z'; // If only T10Z is present
