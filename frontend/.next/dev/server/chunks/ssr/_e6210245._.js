...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])('/api/auth/login', {
                method: 'POST',
                headers: {
...
//# sourceMappingURL=_e6210245._.js.map